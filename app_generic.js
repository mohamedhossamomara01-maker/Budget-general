...
function _getUserId() {
  try {
    let id = localStorage.getItem("app_user_id_v1");
    if (!id) {
      id = "u_" + Date.now().toString(36) + "_" + Math.random().toString(36).slice(2, 10);
      localStorage.setItem("app_user_id_v1", id);
    }
    return id;
  } catch { return "u_fallback"; }
}
const USER_ID = _getUserId(); // معرّف فريد لكل جهاز/شخص، عشان كل واحد يستخدم التطبيق تكون بياناته منفصلة على السحابة
...
function SalaryModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "💸 سحب من الشريك"), /*#__PURE__*/React.createElement(Fld, {
    k: "duha_w_sal",
    ...
    style: S.sub
  }, "👥 مرتب الشريك (الفلوس اللي بتدّيها للشريك)"), /*#__PURE__*/React.createElement("input", {
    style: {
      ...S.inp,
      fontSize: 17,
      fontWeight: 700,
  ...
  }, "دخل ", fmt(inc), " − ثوابت ", fmt(fix), " − الشريك ", fmt(n("home_given")))), /*#__PURE__*/React.createElement("button", {
    style: S.btn(T.green),
    onClick: () => onSave(mk, {
      ...f
    })
...
function CategoryScreen({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Tabs, {
    ...
    }, c.l, e.paidBy && e.paidBy !== (entryType === "duha" ? "doha" : "mohamed") ? (e.paidBy === "tahwish" ? " · 💰 من التحويش" : e.paidBy === "doha" ? " · 👥 من مرتب الشريك" : " · 👤 من مرتبي") : ""))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 8,
        alignItems: "center"
    ...
    { v: "doha", l: "👩 مرتب الشريك", clr: "#ec4899" },
    { v: "mohamed", l: "👨 مرتبي", clr: "#3b82f6" },
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      /*#__PURE__*/React.createElement("div", {style:{display:"flex",gap:8}},
        ...
        /*#__PURE__*/React.createElement("div", null,
          ...
          /*#__PURE__*/React.createElement("div", {style:{fontSize:10,color:"#4a6080"}}, c.l, e.paidBy && e.paidBy !== (entryType === "duha" ? "doha" : "mohamed") ? (e.paidBy === "tahwish" ? " · 💰 من التحويش" : e.paidBy === "doha" ? " · 👥 من مرتب الشريك" : " · 👤 من مرتبي") : "")
        )
      ),
...
function CarScreen({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Tabs, {
    ...
    }, e.date, e.km ? ` · ${e.km} كم` : "", e.note ? ` · ${e.note}` : "", e.paidBy === "doha" ? " · 👩 مرتب الشريك" : e.paidBy === "tahwish" ? " · 💰 من التحويش" : "", e.dueKm ? ` · 🎯 الميعاد الجاي ${fmt(e.dueKm)} كم` : ""))), /*#__PURE__*/React.createElement("div", {
  ...
  }, "👩 مرتب الشريك"), /*#__PURE__*/React.createElement("button", {
...
function App({ profile, setProfile }) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    *{box-sizing:border-box;}input::-webkit-outer-spin-button,input::-webkit-inner-spin-button{-webkit-appearance:none;}
  ...
  }, tab === "summary" ? "📊 الملخص" : tab === "duha" ? "👩 الشريك" : tab === "food" ? "👨 أنا" : tab === "car" ? "🚗 العربية" : tab === "indrive" ? "🛺 إندرايف" : "🎯 أهدافي"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 5
    ...
    budgetLabel: "مرتب الشريك",
    defaultBudget: 10000,
    addTitle: "إضافة مصروف الشريك",
    extraEntries: entries.filter(e => e.type === "car" && e.paidBy === "doha")
...
function AppGate() {
  const [profile, setProfileState] = useState(() => ld("app_profile_v1", null));
  const setProfile = (p) => { sv("app_profile_v1", p); setProfileState(p); };
  if (!profile) {
